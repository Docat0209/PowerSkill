...
- **Instant learning:** when self-review or any verification step discovers a mistake, GENERALIZE it into a universal principle and write to `memory/principles.md`. Format: `[Category] [Universal rule]`. Not an event log — a reusable principle that prevents ALL similar future mistakes. De-duplicate before adding.
