---
name: growth-track
description: "Tracks AARRR metrics, budget, and growth experiments. Triggers ONLY when: user asks to check metrics, plan growth experiments, manage budget, or review funnel performance. Do NOT trigger during development or content creation."
---
...
- **Cohort analysis:** compare retention curves across signup cohorts to detect improvement or regression
