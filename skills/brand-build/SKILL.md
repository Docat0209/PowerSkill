...
1. Search the web for how competitors position themselves — your positioning must be clearly distinct
...
1. **Explaining a feature:** [sentence in-voice]
2. **Handling an error/problem:** [sentence in-voice]
3. **Celebrating a win:** [sentence in-voice]
...
- [ ] Matches the 3 voice adjectives
...
1. Consistent reinforcement of shared values
2. Creating opportunities for tribe members to connect with each other
...
1. Is the positioning still accurate? Has the product or market shifted?
2. Is the voice consistent across all recent content? Pull 5 recent pieces and check.
